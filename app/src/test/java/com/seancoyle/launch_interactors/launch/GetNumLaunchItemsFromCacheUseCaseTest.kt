...
import com.seancoyle.launch_interactors.launch.GetNumLaunchItemsFromCacheUseCase.Companion.GET_NUM_LAUNCH_ITEMS_SUCCESS
...
class GetNumLaunchItemsFromCacheUseCaseTest {
    ...
    fun getNumLaunchItems_success_confirmCorrect() = runBlocking {
        ...
        var numItems = 0
        getNumLaunchItemsFromCacheUseCase.execute(
