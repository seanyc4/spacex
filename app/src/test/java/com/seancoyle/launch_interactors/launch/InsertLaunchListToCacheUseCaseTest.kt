...
import com.seancoyle.launch_interactors.launch.InsertLaunchListToCacheUseCase.Companion.INSERT_LAUNCH_LIST_SUCCESS
...
class InsertLaunchListToCacheUseCaseTest {
    ...
    fun insertLaunchList_success() = runBlocking {
        ...
        insertLaunchListToCacheUseCase.execute(
