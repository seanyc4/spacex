object Build {
    ...
    const val secrets_gradle_plugin =
        "com.google.android.libraries.mapsplatform.secrets-gradle-plugin:secrets-gradle-plugin:$secrets_gradle_plugin_verison"
    ...
    const val safe_args =
        "androidx.navigation:navigation-safe-args-gradle-plugin:${AndroidX.navigation_version}"
