...
private fun ImageDto.toDomain() =
    Image(
        id = id,
        name = name,
        imageUrl = imageUrl ?: LaunchConstants.DEFAULT_LAUNCH_IMAGE,
        thumbnailUrl = thumbnailUrl ?: LaunchConstants.DEFAULT_LAUNCH_THUMBNAIL,
        credit = credit
    )
...
private fun defaultImage() =
    Image(
        id = null,
        name = null,
        imageUrl = LaunchConstants.DEFAULT_LAUNCH_IMAGE,
        thumbnailUrl = LaunchConstants.DEFAULT_LAUNCH_THUMBNAIL,
        credit = null
    )
