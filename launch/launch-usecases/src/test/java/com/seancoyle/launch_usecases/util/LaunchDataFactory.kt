...
constructor(
    ...
    fun produceFakeAppDatabase(launchList: List<LaunchModel>): com.seancoyle.launch_datasource.cache.launch.FakeLaunchDatabase {
        val database = com.seancoyle.launch_datasource.cache.launch.FakeLaunchDatabase()
